...
class MongoAdapter(LeagueRepo):
    """
    Szkielet adaptera pod NoSQL dokumentowy (Mongo) wg Twojego przykładu struktur.
    """
    ...
    def list_leagues(self, *, q: Optional[str] = None, filters=None) -> Sequence[Mapping[str, Any]]:
        raise NotImplementedError("MongoAdapter.list_leagues: do zrobienia po integracji DB")
